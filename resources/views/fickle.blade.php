        ...
        <ul class="mainNav">
            ...
            <li class="active">
                ...
                <ul>
                    ...
                    <li><a class="active" href="select-tag.html">Select & Tag</a></li>
        ...
        <div id="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <!--Top header start-->
                        <h3 class="ls-top-header">Select & Tag</h3>
                        <!--Top header end -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="ls-header">Select & search</h3>
                    ...
                    <div class="col-md-6">
                        <h3 class="ls-header">Multi Select</h3>
                        <select id="select-state" name="state[]" multiple class="demo-default" placeholder="Select a state...">
                        ...
                        <span class="help_text">Maximum items 3 </span>
                    </div>
                </div>
                <hr/>
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="ls-header">Contact</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="ls-header">Multiple Tags</h3>
                        <input type="text" class="input-tags" name="example_name" value="Osx,Ubuntu,Debian,Mint,IOS,Android"/>
                    </div>
                    <div class="col-md-6">
                        <h3 class="ls-header">Single Tag</h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="ls-header">Options groups</h3>
                        <select id="select-repeated-options" class="demo-default" multiple>
                            ...
                            <optgroup label="Group 4">
                                ...
                                <option value="c">Item C</option>
                                <option value="d">Item D</option>
                                <option value="a1">Item A:1</option>
                                <option value="b2">Item B:2</option>
                                <option value="c3">Item C:3</option>
                                <option value="d4">Item D:4</option>
                            </optgroup>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="ls-header">Disabled</h3>
                        <select id="select-state-disabled" name="state[]" multiple disabled class="demo-default"  placeholder="Select a state...">
                            <option value="">Select a state...</option>
                            <option value="AL">Alabama</option>
                    ...
                    <div class="col-md-6">
                        <h3 class="ls-header">Drag & Drop</h3>
